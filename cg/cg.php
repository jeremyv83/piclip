...
<head>
    ...
    <title>Conditions Utilisations</title>
</head>
<body>
    ...
    <br>
        ...
        <br>
        En vigueur au 28/02/2021<br>
        Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement juridique des modalités de mise à disposition du site et des services par Coin Coin Dev et de définir les conditions d’accès et d’utilisation des services par « l'Utilisateur ».
        ...
        piclip.com se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes CGU.<br><br>
        <h3>Article 1 : Les mentions légales</h3><br>
        L’édition et la direction de la publication du site piclip.com est assurée par Coin coin dev, domicilié 69 rue de la marre.
        Numéro de téléphone est 0662288052 Adresse e-mail dodo.oscrypto@gmail.com.<br>
        L'hébergeur du site piclip.com est la société netlify, dont le siège social est situé au 69 rue de la Marre.<br>
        <h3>ARTICLE 2 : Accès au site</h3><br>
        Le site piclip.com permet à l'Utilisateur un accès gratuit aux services suivants :<br>
        1
        <br>
        Le site internet propose les services suivants : Partage de vidéos<br>
        ...
        L’Utilisateur non membre n'a pas accès aux services réservés. Pour cela, il doit s’inscrire en remplissant le formulaire. En acceptant de s’inscrire aux services réservés, l’Utilisateur membre s’engage à fournir des informations sincères et exactes concernant son état civil et ses coordonnées, notamment son adresse email.<br><br>
        ...
        Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du site ou serveur et sous réserve de toute interruption ou modification en cas de maintenance, n'engage pas la responsabilité de piclip.com. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à l’éditeur de toute interruption ou suspension de service, même sans préavis.<br>
        ...
        <h3>ARTICLE 3 : Collecte des données</h3><br>
        ...
        <br>
        <h3>ARTICLE 5 : Responsabilité</h3><br><br>
        Les sources des informations diffusées sur le site piclip.com sont réputées fiables mais le site ne garantit pas qu’il soit exempt de défauts, d’erreurs ou d’omissions.<br>
        Les informations communiquées sont présentées à titre indicatif et général sans valeur contractuelle. Malgré des mises à jour régulières, le site piclip.com ne peut être tenu responsable de la modification des dispositions administratives et juridiques survenant après la publication. De même, le site ne peut être tenue responsable de l’utilisation et de l’interprétation de l’information contenue dans ce site.<br>
        ...
        Le site piclip.com ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter l’ordinateur ou tout matériel informatique de l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement provenant de ce site.<br>
        ...
        <br>
        <h3>ARTICLE 6 : Liens hypertextes</h3><br>
        Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces liens, il sortira du site piclip.com. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles aboutissent ces liens et ne saurait, en aucun cas, être responsable de leur contenu.
        <br>
        <h3>ARTICLE 7 : Cookies</h3><br>
        3
        <br>
        ...
        Les cookies sont de petits fichiers stockés temporairement sur le disque dur de l’ordinateur de l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site piclip.com. Les cookies ne contiennent pas d’information personnelle et ne peuvent pas être utilisés pour identifier quelqu’un. Un cookie contient un identifiant unique, généré aléatoirement et donc anonyme. Certains cookies expirent à la fin de la visite de l’Utilisateur, d’autres restent.<br>
        L’information contenue dans les cookies est utilisée pour améliorer le site piclip.com. En naviguant sur le site, L’Utilisateur les accepte.<br>
        ...
        <br>
        <h3>ARTICLE 8 : Publication par l’Utilisateur</h3><br>
        Le site permet aux membres de publier les contenus suivants : Partage de vidéos.<br>
        ...
        <br>
        <h3>ARTICLE 9 : Droit applicable et juridiction</h3><br>
        4
        <br>
        compétente<br>
